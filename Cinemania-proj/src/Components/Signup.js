...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const newUser = { ...datastate, creditCard }; // Include credit card information in the user data
      ...
      <Form className="login-form" onSubmit={handleSubmit}>
        <Form.Group controlId="formBasicFirstName">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, firstName: e.target.value })
            }
            required
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicLastName">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, lastName: e.target.value })
            }
            required
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicPassword">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, password: e.target.value })
            }
            required
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicConfirmPassword">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, confirmPassword: e.target.value })
            }
            required
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicBillingAddress">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, billingAddress: e.target.value })
            }
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicHomeAddress">
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setData({ ...datastate, homeAddress: e.target.value })
            }
            required
          />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicCheckbox">
          <Form.Check
            ...
            onChange={(e) =>
              setData({ ...datastate, promoSubscription: e.target.checked })
        ...
        <Form.Group className="mb-3" controlId="formBasicCheckbox">
          <Form.Check
            ...
            checked={datastate.type === 2} // Check if type is set to 2
            onChange={(e) => {
              const newType = e.target.checked ? 2 : 1; // Set type to 2 if checkbox is checked, otherwise set to 1
              setData({ ...datastate, type: newType }); // Update type in state
            }}
          />
        </Form.Group>
